...
- Tue 8 Sep 2026: Admin screening inventory buttons now show immediate feedback and keep saved values visible after saving.
...
- Wed 9 Sep 2026: Screening inventory now enforces one row per event and venue combination, merging duplicate rows into the selected venue record.
